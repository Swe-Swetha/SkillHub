        ...
        <div className="flex justify-between p-6 items-center">
          ...
          <ul className="flex gap-4">
            {tabs.map((tab, id) => (
              <li
                key={id}
                className={`hover:cursor-pointer rounded-full px-4 py-2 transition ${
                  activeTab === tab
                    ? "bg-[#161179] text-white"
                    : "hover:bg-gray-100"
                }`}
          ...
          <div className="flex items-center gap-6 relative" ref={profileRef}>
            ...
            <div
              ...
              onClick={() => handleTabClick("Skillbucks")}
            >
              $
            </div>
              ...
              {isProfileDropdownOpen && (
                <div className="absolute right-0 mt-4 w-40 bg-white border rounded shadow-md z-50">
                  <ul className="text-sm text-gray-700">
                    ...
                    <li
                      className="flex gap-1 items-center px-4 py-2 hover:bg-red-100 text-red-600 cursor-pointer"
