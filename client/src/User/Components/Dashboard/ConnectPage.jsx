...
//         <h1 className="text-3xl font-bold text-center mt-2">Find Skill Partners</h1>
//         <p className="text-center text-gray-700 mb-2 ">
// A thriving hub where learners and mentors connect, exchange knowledge, and grow meaningful relationships through skill-sharing.</p>
...
//             <h2 className="text-xl font-semibold mb-2">Start Mentoring</h2>
//             <p className="text-gray-600 mb-4">
...
//               <div
//                 key={user._id}
//                 className="flex flex-col justify-between bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 transform hover:-translate-y-1 border border-gray-100 min-h-[260px]"
//               >
//                 <div>
...
//                       <span
//                         key={index}
//                         className="border border-red-500 text-red-500 px-3 py-1 rounded-full font-medium"
//                       >
//                         {skill}
//                       </span>
//                     ))}
